...
sai_status_t stub_tai_set_optical_module_attribute(sai_object_id_t optical_module_id, const sai_attribute_t *attr){
    return SAI_STATUS_SUCCESS;
}

sai_status_t stub_tai_get_optical_module_attribute(sai_object_id_t id, uint32_t attr_count, sai_attribute_t *attr_list){
    return SAI_STATUS_SUCCESS;
}

sai_status_t stub_tai_get_optical_module_stats(sai_object_id_t optical_module_id, uint32_t number_of_counters, const tai_optical_module_stat_t *counter_ids, uint64_t *counters){
    return SAI_STATUS_SUCCESS;
}
...
sai_status_t stub_tai_create_device(sai_object_id_t *device_id, uint32_t attr_count, const sai_attribute_t *attr_list) {
    return SAI_STATUS_SUCCESS;
}
...
sai_status_t stub_tai_set_device_attribute(sai_object_id_t device_id, const sai_attribute_t *attr_list) {
    return SAI_STATUS_SUCCESS;
}

sai_status_t stub_tai_get_device_attribute(sai_object_id_t device_id, uint32_t attr_count, sai_attribute_t *attr_list) {
    return SAI_STATUS_SUCCESS;
}
